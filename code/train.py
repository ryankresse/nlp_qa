...
tf.app.flags.DEFINE_string("train_dir", "train_dir/tiny_samp/concat_cont_and_att", "Training directory to save the model parameters (default: ./train).")
tf.app.flags.DEFINE_string("load_train_dir", "train_dir/tiny_samp/concat_cont_and_att", "Training directory to load model parameters from to resume training (default: {train_dir}).")
tf.app.flags.DEFINE_string("ckpt_file_name", "concat_cont_and_att", "Checkpoint file name")
